...
public class Crypter {
    ...
    public static String crypt(String enteredPassword) {
        ...
        if (pwdlength < 9) {
            ...
            encryptedPassword =
                "A" + encryptedPassword1 + encryptedPassword2.substring(2, 13);
    ...
    * @param encryptedPassword The <I>encryptedPassword</I>. The
    * two characters at position 2 and 3 are assumed to be the salt.
    * This string would be the same as one found in a Unix
    * <U>/etc/passwd</U> file.
