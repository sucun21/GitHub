...
DROP PROCEDURE IF EXISTS web_cms_get_pending_check_attendance_class;
//

CREATE PROCEDURE `web_cms_get_pending_check_attendance_class`(
	p_is_admin BIT,
	p_course_id INT,
    p_center_id INT,
    p_trainer_id INT
