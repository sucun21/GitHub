...
DROP PROCEDURE IF EXISTS web_cms_student_get_other_activity;
//

CREATE PROCEDURE `web_cms_student_get_other_activity`(
...
BEGIN
    ...
    SELECT  sa.activity_name `activityName`,
    ...
    WHERE (p_lesson_id IS NULL OR sta.lesson_id = p_lesson_id)
          ...
          AND sa.activity_type_id NOT IN (1, 4)
